...
> **Welcome to Service-Track Week 9, Task 7!**
...
| `src/dataProcessor.py` | Main source code - **has bugs to fix** |
| `src/v1_dataProcessor.py` | Supporting code - **may also have bugs** |
| `src/v2_dataProcessor.py` | Supporting code - **may also have bugs** |
| `src/v3_dataProcessor.py` | Supporting code - **may also have bugs** |
| `src/v4_dataProcessor.py` | Supporting code - **may also have bugs** |
| `src/v5_dataProcessor.py` | Supporting code - **may also have bugs** |
| `tests/test_processor.py` | Test file - **add your tests here** |
...
### Incident - `src/v3_dataProcessor.py`
**User Report / Alert:**
> "introduced here: divides by total instead of len(self.records)"
